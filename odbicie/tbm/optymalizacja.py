...
def optimize_atr_tbm(
    ...
    tp_trail_mults: list,
    max_holding_bars_list: list,
    enter_on_close_list: list = [False],
    time_decay_sl: bool = False,
    time_decay_mult: float = 1.0,
    ...
    entry_grid = list(itertools.product(
        atr_periods, atr_factors, max_setup_hold_bars_list, enter_on_close_list
    ))
    ...
    def build_kwargs(combo, mkt):
        atr_p, atr_f, max_setup, eoc = combo
        return dict(
    ...
    return _run_optimization_loop(
        ...
        entry_param_names=['atr_period', 'atr_factor', 'max_setup_bars', 'enter_on_close'],
        market_data_daily=market_data_daily,
        tp_mults=tp_mults,
        sl_mults=sl_mults,
...
def optimize_bb_tbm(
    ...
    """
    entry_grid = list(itertools.product(
        bb_periods, bb_stds, max_setup_hold_bars_list, enter_on_close_list
    ))
    exit_grid = list(itertools.product(
        tp_mults, sl_mults, tp_trail_mults, max_holding_bars_list
    ))
    ...
    return _run_optimization_loop(
        ...
        entry_fn_kwargs_builder=build_kwargs,
        entry_param_names=['bb_period', 'bb_std', 'max_setup_bars', 'enter_on_close'],
        market_data_daily=market_data_daily,
        tp_mults=tp_mults,
        sl_mults=sl_mults,
        tp_trail_mults=tp_trail_mults,
